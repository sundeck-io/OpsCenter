...
as $$
    ...
    util as (
        ...
        where period::DATE between INPUT_START_DATE and INPUT_END_DATE and case when INPUT_WAREHOUSE_NAME is null then true else warehouse_name = INPUT_WAREHOUSE_NAME end and warehouse_id < 10000
        group by 1
	)
