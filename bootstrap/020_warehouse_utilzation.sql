...
returns table (period timestamp, utilization number(38,12))
as $$
	with ccost as (
    ...
    util as (
        ...
        where period between INPUT_START_DATE::DATE and INPUT_END_DATE::DATE and case when INPUT_WAREHOUSE_NAME is null then true else warehouse_name = INPUT_WAREHOUSE_NAME end
        group by 1
	)
    ...
    where d.date between INPUT_START_DATE::DATE and INPUT_END_DATE::DATE
$$;
