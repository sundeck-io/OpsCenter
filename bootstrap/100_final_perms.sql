...
-- Grant select on current views in REPORTING
...
-- Grant select on future views in REPORTING
grant select on future views in schema REPORTING to APPLICATION ROLE ADMIN;
grant select on future views in schema REPORTING to APPLICATION ROLE READ_ONLY;
...
-- Grant select on current views in CATALOG
...
-- Grant select on future views in CATALOG
grant select on future views in schema CATALOG to APPLICATION ROLE ADMIN;
grant select on future views in schema CATALOG to APPLICATION ROLE READ_ONLY;
